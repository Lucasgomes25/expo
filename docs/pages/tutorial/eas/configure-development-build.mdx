...
export default function App() {
  ...
  const servicos = [
    ...
    "Limpeza e Hidratação em Bancos de Couro",
  ...
  const adicionarAgendamento = () => {
    if (cliente && telefone && servico) {
      setAgenda([...agenda, { cliente, telefone, servico, status: "Agendado" }]);
      setCliente('');
      setTelefone('');
      setServico('');
    }
  ...
  const atualizarStatus = (index, novoStatus) => {
    ...
    novaAgenda[index].status = novoStatus;

    // Enviar mensagem via WhatsApp
    const mensagem = `Olá ${novaAgenda[index].cliente}, seu veículo está com status: ${novoStatus}.`;
    Linking.openURL(`https://wa.me/${novaAgenda[index].telefone}?text=${encodeURIComponent(mensagem)}`);
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Lucas Gomes - Estética Automotiva</Text>
      ...
      <Button title="Agendar Cliente" onPress={adicionarAgendamento} />
      ...
      <FlatList
        ...
        renderItem={({ item, index }) => (
          <View style={styles.card}>
            <Text style={styles.cardText}>{item.cliente} - {item.servico}</Text>
            <Text>Status: {item.status}</Text>
            <View style={styles.buttons}>
              <TouchableOpacity onPress={() => atualizarStatus(index, "Agendado")}>
                <Text style={styles.btn}>Agendado</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => atualizarStatus(index, "Limpeza Iniciada")}>
                <Text style={styles.btn}>Iniciada</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => atualizarStatus(index, "Limpeza Concluída")}>
                <Text style={styles.btn}>Concluída</Text>
              </TouchableOpacity>
            </View>
          </View>
        )}
